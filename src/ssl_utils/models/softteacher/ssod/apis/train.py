...
from ssl_utils.models.softteacher.ssod.utils import find_latest_checkpoint, get_root_logger, patch_runner
...
def train_detector(
    ...
    # 作者重写了 runner.save_checkpoint() 方法，
    # 重写是通过 types.MethodType(newMethod, object) 将 newMethod 转为 object对象
