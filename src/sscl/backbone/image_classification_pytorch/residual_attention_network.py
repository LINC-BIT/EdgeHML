"""
RAN from https://github.com/tengshaofeng/ResidualAttentionNetwork-pytorch/tree/master/Residual-Attention-Network/model
"""
...
class ResidualBlock(nn.Module):
    def __init__(self, input_channels, output_channels, stride=1):
        ...
        # bugfix: 原代码中“output_channels / 4”是float，但Conv2d要求是int，所以改为整除“//”：
...
class ResidualAttentionModel_92_32input_update(BaseBackbone):
    # for input size 32
    # 增加了 num_classes 参数
